...
import timber from './Robson-Timber.jpg'
...
export default ( props ) => (
  <Layout {...props}>
    ...
    />
    <p>They had <strong>nine</strong> known children - the first two were born in Blythe, Northumberland: <strong>John Thomas Robson
      </strong> (born 1859) and <strong>Margaret Robson</strong> (born 1860); <strong>Jane Ann
      </strong> (born 1863-1931); and then the latter 5 in Sunderland - <strong>Isabella</strong> Robson (1865), <strong>Barbara
      </strong>(1867), <strong>Mary Anna</strong> (1869), <strong>Emily
      </strong> (1872-1924), William (1877 who died at 20 months old) and <strong>William</strong> (1879).</p>
    ...
    <p>Jane Ann, married Christopher Hill <a href="/family/hodgson">Hodgson</a> (a grocer and part time photographer) and had four children, William Robson Hodgson (WRH), Norah, Ena and Mary. All are pictured in the photo above.</p>
    ...
    <Thumbnail src={timber} large={true}
       caption="The timber business owned by William Robson"
    />
